...
function estiloNegro() {
    
    var theme = document.getElementsByTagName('link')[0];

    
    if (theme.getAttribute('href') == 'css/whitestyle.css') {
        theme.setAttribute('href', 'css/blackstyle.css');
    } 
}

function estiloBlanco() {
    
    var theme = document.getElementsByTagName('link')[0];

    
    if (theme.getAttribute('href') == 'css/blackstyle.css') {
        theme.setAttribute('href', 'css/whitestyle.css');
    } 
}
...
/* Ejercicio 2: Generar una funcion que haga mostrar la contraseña.*/
    ...
    checkbox = document.getElementById('checkboxPassword');
    passField = document.getElementById('inputPassword');
...
function analizarContrasenia(){
    ...
    if( password.value === null || password.value === ''){
        formIdTest.textContent = "el campo esta vacio";
        formTest.style.color = "red";
        return true;
...
function reset(){ 
    ...
    var cantidad = document.getElementById('colCantidades');
    cantidad.reset()
...
function armarEstructuraCadena(){
    ...
    for( cadenaIngrasa of secuencia){
...
function sonConsecutivos(elem1,elem2){
    ...
    if( esNumero(elem1) && esNumero(elem2)){
        ...
        if(consecuvtivosNumericos(elem1,elem2))
        { 
